    ...
    <form class="form-horizontal" method="post"
        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="name" name="name" class="input-xlarge" value="<?php echo $article['name']?>" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="intro" name="intro" class="input-xlarge" value="<?php echo $article['intro']?>" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <img id="thumb_img" src="<?php echo base_url().$article['cover']?>" style="max-height:100px; " />
                    <input id="cover" type="text" name="pic" value="<?php echo $article['cover']?>" class="input-xlarge hide" readonly="readonly" data-rule-required="true" data-rule-url="true" />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="message" id="message" style="width:700px;height:200px;visibility:hidden;"><?php echo $article['message']?></textarea>
    ...
    $(document).ready(function() {
        ...
        $('#save_form_btn').click(function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data:{action:'save',id:$('#id').val(),cover:$('#cover').val(),message:$('#message').val(),name:$('#name').val(),intro:$('#intro').val()},
