...
<div class="col-md-9">
    ...
    <div class="col-md-9">
        <form class="form-horizontal" role="form" style="margin-top: 60px;" name="change_password" id="change_password" action="<?php echo site_url('user/account/do_change_password')?>" method="post">
