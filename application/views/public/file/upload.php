        ...
        <td>
            <span class="preview">
                {% if (file.thumbnailUrl) { %}
                    <a href="javascript:void(0);" title="{%=file.name%}" download="{%=file.name%}" data-gallery><img src="{%=file.thumbnailUrl%}"></a>
                {% } %}
...
<script src="<?php echo $file_upload_url ?>js/main.js"></script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE 8 and IE 9 -->
<!--[if (gte IE 8)&(lt IE 10)]>
<script src="<?php echo $file_upload_url ?>js/cors/jquery.xdr-transport.js"></script>
<![endif]-->
<script src="<?php echo base_url().'static/' ?>js/jquery.json.min.js"></script>
</body>
</html>